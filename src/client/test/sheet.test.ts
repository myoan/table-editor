...
describe('Sheet', () => {
    ...
    describe('#new', () => {
        test('create cell', () => {
            ...
            expect(s.cells[0][0].pos.x).toBe(1)
            expect(s.cells[0][0].pos.y).toBe(1)
            expect(s.cells[0][0].index.x).toBe(0)
            expect(s.cells[0][0].index.y).toBe(0)
            expect(s.cells[0][1].value).toBe('name')
            expect(s.cells[0][1].pos.x).toBe(152)
            expect(s.cells[0][1].pos.y).toBe(1)
            expect(s.cells[0][1].index.x).toBe(1)
            expect(s.cells[0][1].index.y).toBe(0)
            expect(s.cells[0][2].value).toBe('release')
            expect(s.cells[0][2].pos.x).toBe(303)
            expect(s.cells[0][2].pos.y).toBe(1)
            expect(s.cells[0][2].index.x).toBe(2)
            expect(s.cells[0][2].index.y).toBe(0)

            expect(s.cells[1][0].value).toBe(1)
            expect(s.cells[1][0].pos.x).toBe(1)
            expect(s.cells[1][0].pos.y).toBe(32)
            expect(s.cells[1][0].index.x).toBe(0)
            expect(s.cells[1][0].index.y).toBe(1)
            expect(s.cells[1][1].value).toBe('pokemon')
            expect(s.cells[1][1].pos.x).toBe(152)
            expect(s.cells[1][1].pos.y).toBe(32)
            expect(s.cells[1][1].index.x).toBe(1)
            expect(s.cells[1][1].index.y).toBe(1)
            expect(s.cells[1][2].value).toBe(1995)
            expect(s.cells[1][2].pos.x).toBe(303)
            expect(s.cells[1][2].pos.y).toBe(32)
            expect(s.cells[1][2].index.x).toBe(2)
            expect(s.cells[1][2].index.y).toBe(1)

            expect(s.cells[2][0].value).toBe(2)
            expect(s.cells[2][0].pos.x).toBe(1)
            expect(s.cells[2][0].pos.y).toBe(63)
            expect(s.cells[2][0].index.x).toBe(0)
            expect(s.cells[2][0].index.y).toBe(2)
            expect(s.cells[2][1].value).toBe('minecraft')
            expect(s.cells[2][1].pos.x).toBe(152)
            expect(s.cells[2][1].pos.y).toBe(63)
            expect(s.cells[2][1].index.x).toBe(1)
            expect(s.cells[2][1].index.y).toBe(2)
            expect(s.cells[2][2].value).toBe(2011)
            expect(s.cells[2][2].pos.x).toBe(303)
            expect(s.cells[2][2].pos.y).toBe(63)
            expect(s.cells[2][2].index.x).toBe(2)
            expect(s.cells[2][2].index.y).toBe(2)

            expect(s.cells[3][0].value).toBe(3)
            expect(s.cells[3][0].pos.x).toBe(1)
            expect(s.cells[3][0].pos.y).toBe(94)
            expect(s.cells[3][0].index.x).toBe(0)
            expect(s.cells[3][0].index.y).toBe(3)
            expect(s.cells[3][1].value).toBe('factorio')
            expect(s.cells[3][1].pos.x).toBe(152)
            expect(s.cells[3][1].pos.y).toBe(94)
            expect(s.cells[3][1].index.x).toBe(1)
            expect(s.cells[3][0].index.y).toBe(3)
            expect(s.cells[3][2].value).toBe(2020)
            expect(s.cells[3][2].pos.x).toBe(303)
            expect(s.cells[3][2].pos.y).toBe(94)
            expect(s.cells[3][2].index.x).toBe(2)
            expect(s.cells[3][2].index.y).toBe(3)
        });
    });
